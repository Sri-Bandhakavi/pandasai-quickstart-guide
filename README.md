...
## View Notebook
- 📊 [View with outputs](https://Sri-Bandhakavi.github.io/pandasai-quickstart-guide/pandasai_quickstart_guide.html) — opens via GitHub Pages (preceding link works, clicking the .html file in the repo shows raw code)
